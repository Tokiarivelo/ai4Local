...
export function FloatingActionButton({ actions, className }: FloatingActionButtonProps) {
  ...
  return (
    <div className={cn('fixed bottom-6 right-6 z-50 flex flex-col items-end space-y-2', className)}>
      {/* Expanded actions */}
      {isExpanded && (
      ...
      <Button
        ...
        aria-label={actionList.length > 1 ? "Menu d'actions rapides" : primaryAction.label}

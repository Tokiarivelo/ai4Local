...
import { BarChart, Link, TestTube, Eye } from 'lucide-react';
...
/**
 * Étape 5: Tracking et A/B tests
 * Configuration UTM, pixels, A/B tests
 */
    ...
    <div className="space-y-8">
      <Card className="p-6">
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-semibold mb-2">Tracking et A/B tests</h3>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 max-w-2xl mx-auto">
            <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <Link className="w-8 h-8 text-blue-500 mb-2" />
